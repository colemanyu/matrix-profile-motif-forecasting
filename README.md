...
└── results
    ...
    └── README.md
```
- Please read [evaluate_pemds7.ipynb](python/evaluate_pemds7.ipynb) to understand the code. `grid_search_*.py` are derived from it for the experiments.
...
Tables
- Tables 4 - 5: [0-base/](results/local_daikon/0-base/)
- Table 6: [1-nnc/](results/local_daikon/1-nnc/)
- Table 7 - 9: [2-k-nn/](results/local_daikon/2-k-nn/)
